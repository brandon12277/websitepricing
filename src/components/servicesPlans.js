...
<div className="flex flex-col mt-20 gap-4 w-full items-center justify-center roboto-thin">
<h1 className="text-4xl font-bold mt-20 mb-10">Services Plans and Pricing</h1>
